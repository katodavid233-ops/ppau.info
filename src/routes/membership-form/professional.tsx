        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormFieldLabel
                        fields={fields}
                        name="physical_address"
                        fallback="Physical Address / Residence"
                      />
                      <FormControl>
                        <Textarea {...field} />
                      </FormControl>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          placeholder={cadre === "Other" ? "Specify cadre or qualification" : ""}
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormFieldLabel
                        fields={fields}
                        name="ahpc_registration_number"
                        fallback="AHPC Registration Number"
                      />
                      <FormControl>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormFieldLabel
                        fields={fields}
                        name="practice_area"
                        fallback="Current practice area"
                      />
                      <Select onValueChange={field.onChange} value={field.value}>
                        <FormControl>
                          <SelectTrigger>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormFieldLabel
                        fields={fields}
                        name="government_facility_name"
                        fallback="Name of government facility"
                      />
                      <FormControl>
                        <Input {...field} />
                      </FormControl>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormFieldLabel
                        fields={fields}
                        name="years_experience"
                        fallback="Years of Professional Experience"
                      />
                      <FormControl>
                      ...
                      <FormControl>
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <Label htmlFor="willing-yes" className="font-normal">
                              Yes
                            </Label>
                          </div>
                          <div className="flex items-center gap-2">
                            <RadioGroupItem value="no" id="willing-no" />
                            <Label htmlFor="willing-no" className="font-normal">
                              No
                            </Label>
                          </div>
                        </RadioGroup>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormFieldLabel
                        fields={fields}
                        name="participation_area"
                        fallback="If yes, specify area of interest"
                      />
                      <FormControl>
          ...
          {currentStep === "Documents" && applicationId && (
            <div className="space-y-4">
              ...
              {currentStep === "Documents" &&
                documents.some((d) => d.required && !uploadedDocs.has(d.type)) && (
          ...
          {currentStep === "Declaration" && (
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                I hereby declare that the information provided is true and correct. I agree to abide
                by the Constitution, regulations, ethical standards, and resolutions of PPAU.
              </p>
              {show("declaration") && (
                <FormField
                  control={form.control}
                  ...
                  render={({ field }) => (
                    <FormItem className="flex items-start gap-2">
                      ...
                      <FormFieldLabel
                        fields={fields}
                        name="declaration"
                        fallback="I accept the declaration above"
